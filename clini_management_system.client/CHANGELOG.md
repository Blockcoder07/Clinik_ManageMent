...
- Create Angular project with ng: `ng new clini_management_system.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`clini_management_system.client.esproj`).
